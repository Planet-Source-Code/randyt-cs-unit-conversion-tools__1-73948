VERSION 5.00
Begin VB.UserControl TempControlNC 
   ClientHeight    =   915
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   2595
   ...
   End
End
Attribute VB_Name = "TempControlNC"
...
Private Unit_cur_Rankine As New UnitElementCls
Private Unit_cur_Kelvin As New UnitElementCls
...
Public Property Get cur_Rankine() As Double
    cur_Rankine = Unit_cur_Rankine.curVal
End Property
Public Property Let cur_Rankine(ByVal New_cur_Rankine As Double)
    Unit_cur_Rankine.curVal = New_cur_Rankine
    UpdateUnits "°Rankine", Unit_cur_Rankine.curVal
    PropertyChanged "cur_Rankine"
End Property
Public Property Get cur_Rankine_err() As Boolean
    cur_Rankine_err = Unit_cur_Rankine.bError
End Property

'=================[ °Kelvin ]
Public Property Get cur_Kelvin() As Double
    cur_Kelvin = Unit_cur_Kelvin.curVal
End Property
Public Property Let cur_Kelvin(ByVal New_cur_Kelvin As Double)
    Unit_cur_Kelvin.curVal = New_cur_Kelvin
    UpdateUnits "°Kelvin", Unit_cur_Kelvin.curVal
    PropertyChanged "cur_Kelvin"
End Property
Public Property Get cur_Kelvin_err() As Boolean
    cur_Kelvin_err = Unit_cur_Kelvin.bError
End Property
...
Private Sub UserControl_Initialize()
    ...
    Unit_cur_Rankine.defVal = 527.67
    Unit_cur_Kelvin.defVal = 293.15
...
Private Sub UserControl_InitProperties()
    ...
    Unit_cur_Rankine.curVal = Unit_cur_Rankine.defVal
    Unit_cur_Kelvin.curVal = Unit_cur_Kelvin.defVal
    StartUp
End Sub
...
Private Sub UserControl_ReadProperties(PropBag As PropertyBag)
    ...
    Unit_cur_Rankine.curVal = PropBag.ReadProperty("cur_Rankine", Unit_cur_Rankine.defVal)
    Unit_cur_Kelvin.curVal = PropBag.ReadProperty("cur_Kelvin", Unit_cur_Kelvin.defVal)
    StartUp
End Sub
...
Private Sub UserControl_WriteProperties(PropBag As PropertyBag)
    ...
    Call PropBag.WriteProperty("cur_Rankine", Unit_cur_Rankine.curVal, Unit_cur_Rankine.defVal)
    Call PropBag.WriteProperty("cur_Kelvin", Unit_cur_Kelvin.curVal, Unit_cur_Kelvin.defVal)
End Sub
...
Private Sub LoadUnitColAndComboBox()
    ...
    Unit_cur_Rankine.uName = "°Rankine": UnitCol.Add Unit_cur_Rankine, "°Rankine"
    Unit_cur_Kelvin.uName = "°Kelvin": UnitCol.Add Unit_cur_Kelvin, "°Kelvin"
    'load combobox
    Combo1.Clear
...
Private Sub UpdateUnits(unitName As String, newVal As Double)
    ...
    Select Case unitName
        Case Is = "°Kelvin"
            nameStr = "°Kelvin": UnitCol(nameStr).bError = False
            tmpDbl = newVal: setRange tmpDbl, nameStr
            UnitCol("°Kelvin").curVal = tmpDbl
            If UnitCol("°Kelvin").curVal < 0 Then UnitCol("°Kelvin").curVal = 0
            nameStr = "°Celsius": UnitCol(nameStr).bError = False
            tmpDbl = UnitCol("°Kelvin").curVal - 273.15
            ...
            nameStr = "°Rankine": UnitCol(nameStr).bError = False
            tmpDbl = UnitCol("°Kelvin").curVal * 9 / 5
            setRange tmpDbl, nameStr
            UnitCol("°Rankine").curVal = tmpDbl
        Case Is = "°Celsius"
            nameStr = "°Celsius": UnitCol(nameStr).bError = False
            tmpDbl = newVal: setRange tmpDbl, nameStr
            UnitCol("°Celsius").curVal = tmpDbl
            ...
            nameStr = "°Kelvin": UnitCol(nameStr).bError = False
            tmpDbl = UnitCol("°Celsius").curVal + 273.15
            setRange tmpDbl, nameStr
            UnitCol("°Kelvin").curVal = tmpDbl
            nameStr = "°Rankine": UnitCol(nameStr).bError = False
            tmpDbl = UnitCol("°Kelvin").curVal * 9 / 5
            ...
            UnitCol("°Rankine").curVal = tmpDbl
            nameStr = "°Fahrenheit": UnitCol(nameStr).bError = False
            tmpDbl = UnitCol("°Rankine").curVal - 459.67
            setRange tmpDbl, nameStr
            UnitCol("°Fahrenheit").curVal = tmpDbl
        Case Is = "°Fahrenheit"
            nameStr = "°Fahrenheit": UnitCol(nameStr).bError = False
            ...
            UnitCol("°Celsius").curVal = tmpDbl
            nameStr = "°Rankine": UnitCol(nameStr).bError = False
            tmpDbl = UnitCol("°Fahrenheit").curVal + 459.67
            setRange tmpDbl, nameStr
            UnitCol("°Rankine").curVal = tmpDbl
            nameStr = "°Kelvin": UnitCol(nameStr).bError = False
            tmpDbl = UnitCol("°Rankine").curVal * 5 / 9
            setRange tmpDbl, nameStr
            UnitCol("°Kelvin").curVal = tmpDbl
        Case Is = "°Rankine"
            nameStr = "°Rankine": UnitCol(nameStr).bError = False
            tmpDbl = newVal: setRange tmpDbl, nameStr
            UnitCol("°Rankine").curVal = tmpDbl
            If UnitCol("°Rankine").curVal < 0 Then UnitCol("°Rankine").curVal = 0
            nameStr = "°Fahrenheit": UnitCol(nameStr).bError = False
            tmpDbl = UnitCol("°Rankine").curVal - 459.67
            setRange tmpDbl, nameStr
            UnitCol("°Fahrenheit").curVal = tmpDbl
