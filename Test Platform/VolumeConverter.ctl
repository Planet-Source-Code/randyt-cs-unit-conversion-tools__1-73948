VERSION 5.00
Begin VB.UserControl VolumeConverter
   ClientHeight    =   915
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   2595
   ...
   End
End
Attribute VB_Name = "VolumeConverter"
...
Private Unit_cur_liter As New UnitElementCls
Private Unit_cur_yard_cube As New UnitElementCls
Private Unit_cur_foot_cube As New UnitElementCls
Private Unit_cur_inch_cube As New UnitElementCls
Private Unit_cur_gallon As New UnitElementCls
Private Unit_cur_cup As New UnitElementCls
...
Public Property Let ctl_sigDigits(ByVal New_ctl_sigDigits As Integer)
    ...
    UpdateUnits "liter", Unit_cur_liter.curVal
...
'=================[ liter ]
Public Property Get cur_liter() As Double
    cur_liter = Unit_cur_liter.curVal
End Property
Public Property Let cur_liter(ByVal New_cur_liter As Double)
    Unit_cur_liter.curVal = New_cur_liter
    UpdateUnits "liter", Unit_cur_liter.curVal
    PropertyChanged "cur_liter"
End Property
Public Property Get cur_liter_err() As Boolean
    cur_liter_err = Unit_cur_liter.bError
End Property

'=================[ yard^3 ]
Public Property Get cur_yard_cube() As Double
    cur_yard_cube = Unit_cur_yard_cube.curVal
End Property
Public Property Let cur_yard_cube(ByVal New_cur_yard_cube As Double)
    Unit_cur_yard_cube.curVal = New_cur_yard_cube
    UpdateUnits "yard^3", Unit_cur_yard_cube.curVal
    PropertyChanged "cur_yard_cube"
End Property
Public Property Get cur_yard_cube_err() As Boolean
    cur_yard_cube_err = Unit_cur_yard_cube.bError
End Property

'=================[ foot^3 ]
Public Property Get cur_foot_cube() As Double
    cur_foot_cube = Unit_cur_foot_cube.curVal
End Property
Public Property Let cur_foot_cube(ByVal New_cur_foot_cube As Double)
    Unit_cur_foot_cube.curVal = New_cur_foot_cube
    UpdateUnits "foot^3", Unit_cur_foot_cube.curVal
    PropertyChanged "cur_foot_cube"
End Property
Public Property Get cur_foot_cube_err() As Boolean
    cur_foot_cube_err = Unit_cur_foot_cube.bError
End Property

'=================[ inch^3 ]
Public Property Get cur_inch_cube() As Double
    cur_inch_cube = Unit_cur_inch_cube.curVal
End Property
Public Property Let cur_inch_cube(ByVal New_cur_inch_cube As Double)
    Unit_cur_inch_cube.curVal = New_cur_inch_cube
    UpdateUnits "inch^3", Unit_cur_inch_cube.curVal
    PropertyChanged "cur_inch_cube"
End Property
Public Property Get cur_inch_cube_err() As Boolean
    cur_inch_cube_err = Unit_cur_inch_cube.bError
End Property

'=================[ gallon ]
Public Property Get cur_gallon() As Double
    cur_gallon = Unit_cur_gallon.curVal
End Property
Public Property Let cur_gallon(ByVal New_cur_gallon As Double)
    Unit_cur_gallon.curVal = New_cur_gallon
    UpdateUnits "gallon", Unit_cur_gallon.curVal
    PropertyChanged "cur_gallon"
End Property
Public Property Get cur_gallon_err() As Boolean
    cur_gallon_err = Unit_cur_gallon.bError
End Property

'=================[ cup ]
Public Property Get cur_cup() As Double
    cur_cup = Unit_cur_cup.curVal
End Property
Public Property Let cur_cup(ByVal New_cur_cup As Double)
    Unit_cur_cup.curVal = New_cur_cup
    UpdateUnits "cup", Unit_cur_cup.curVal
    PropertyChanged "cur_cup"
End Property
Public Property Get cur_cup_err() As Boolean
    cur_cup_err = Unit_cur_cup.bError
End Property
...
Private Sub UserControl_Initialize()
    'set default values
    Unit_cur_liter.defVal = 1#
    Unit_cur_yard_cube.defVal = 1.3079506193144E-03#
    Unit_cur_foot_cube.defVal = 0.035314666721489#
    Unit_cur_inch_cube.defVal = 61.023744094732#
    Unit_cur_gallon.defVal = 0.26417205235815#
    Unit_cur_cup.defVal = 4.2267528377304#
...
Private Sub UserControl_InitProperties()
    ...
    Unit_cur_liter.curVal = Unit_cur_liter.defVal
    Unit_cur_yard_cube.curVal = Unit_cur_yard_cube.defVal
    Unit_cur_foot_cube.curVal = Unit_cur_foot_cube.defVal
    Unit_cur_inch_cube.curVal = Unit_cur_inch_cube.defVal
    Unit_cur_gallon.curVal = Unit_cur_gallon.defVal
    Unit_cur_cup.curVal = Unit_cur_cup.defVal
    StartUp
End Sub
...
Private Sub UserControl_ReadProperties(PropBag As PropertyBag)
    ...
    Unit_cur_liter.curVal = PropBag.ReadProperty("cur_liter", Unit_cur_liter.defVal)
    Unit_cur_yard_cube.curVal = PropBag.ReadProperty("cur_yard_cube", Unit_cur_yard_cube.defVal)
    Unit_cur_foot_cube.curVal = PropBag.ReadProperty("cur_foot_cube", Unit_cur_foot_cube.defVal)
    Unit_cur_inch_cube.curVal = PropBag.ReadProperty("cur_inch_cube", Unit_cur_inch_cube.defVal)
    Unit_cur_gallon.curVal = PropBag.ReadProperty("cur_gallon", Unit_cur_gallon.defVal)
    Unit_cur_cup.curVal = PropBag.ReadProperty("cur_cup", Unit_cur_cup.defVal)
    StartUp
End Sub
...
Private Sub UserControl_WriteProperties(PropBag As PropertyBag)
    ...
    Call PropBag.WriteProperty("cur_liter", Unit_cur_liter.curVal, Unit_cur_liter.defVal)
    Call PropBag.WriteProperty("cur_yard_cube", Unit_cur_yard_cube.curVal, Unit_cur_yard_cube.defVal)
    Call PropBag.WriteProperty("cur_foot_cube", Unit_cur_foot_cube.curVal, Unit_cur_foot_cube.defVal)
    Call PropBag.WriteProperty("cur_inch_cube", Unit_cur_inch_cube.curVal, Unit_cur_inch_cube.defVal)
    Call PropBag.WriteProperty("cur_gallon", Unit_cur_gallon.curVal, Unit_cur_gallon.defVal)
    Call PropBag.WriteProperty("cur_cup", Unit_cur_cup.curVal, Unit_cur_cup.defVal)
End Sub
...
Private Sub LoadUnitColAndComboBox()
    ...
    Unit_cur_liter.uName = "liter": UnitCol.Add Unit_cur_liter, "liter"
    Unit_cur_yard_cube.uName = "yard^3": UnitCol.Add Unit_cur_yard_cube, "yard^3"
    Unit_cur_foot_cube.uName = "foot^3": UnitCol.Add Unit_cur_foot_cube, "foot^3"
    Unit_cur_inch_cube.uName = "inch^3": UnitCol.Add Unit_cur_inch_cube, "inch^3"
    Unit_cur_gallon.uName = "gallon": UnitCol.Add Unit_cur_gallon, "gallon"
    Unit_cur_cup.uName = "cup": UnitCol.Add Unit_cur_cup, "cup"
    'load combobox
    Combo1.Clear
