VERSION 5.00
Begin VB.UserControl ForceControl
   ClientHeight    =   915
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   2595
   ...
   End
End
Attribute VB_Name = "ForceControl"
...
Private Unit_cur_N As New UnitElementCls
Private Unit_cur_gf As New UnitElementCls
Private Unit_cur_kgf As New UnitElementCls
Private Unit_cur_lbf As New UnitElementCls
Private Unit_cur_ozf As New UnitElementCls
...
Public Property Let ctl_sigDigits(ByVal New_ctl_sigDigits As Integer)
    ...
    UpdateUnits "N", Unit_cur_N.curVal
...
'=================[ N ]
Public Property Get cur_N() As Double
    cur_N = Unit_cur_N.curVal
End Property
Public Property Let cur_N(ByVal New_cur_N As Double)
    Unit_cur_N.curVal = New_cur_N
    UpdateUnits "N", Unit_cur_N.curVal
    PropertyChanged "cur_N"
End Property
Public Property Get cur_N_err() As Boolean
    cur_N_err = Unit_cur_N.bError
End Property

'=================[ gf ]
Public Property Get cur_gf() As Double
    cur_gf = Unit_cur_gf.curVal
End Property
Public Property Let cur_gf(ByVal New_cur_gf As Double)
    Unit_cur_gf.curVal = New_cur_gf
    UpdateUnits "gf", Unit_cur_gf.curVal
    PropertyChanged "cur_gf"
End Property
Public Property Get cur_gf_err() As Boolean
    cur_gf_err = Unit_cur_gf.bError
End Property

'=================[ kgf ]
Public Property Get cur_kgf() As Double
    cur_kgf = Unit_cur_kgf.curVal
End Property
Public Property Let cur_kgf(ByVal New_cur_kgf As Double)
    Unit_cur_kgf.curVal = New_cur_kgf
    UpdateUnits "kgf", Unit_cur_kgf.curVal
    PropertyChanged "cur_kgf"
End Property
Public Property Get cur_kgf_err() As Boolean
    cur_kgf_err = Unit_cur_kgf.bError
End Property

'=================[ lbf ]
Public Property Get cur_lbf() As Double
    cur_lbf = Unit_cur_lbf.curVal
End Property
Public Property Let cur_lbf(ByVal New_cur_lbf As Double)
    Unit_cur_lbf.curVal = New_cur_lbf
    UpdateUnits "lbf", Unit_cur_lbf.curVal
    PropertyChanged "cur_lbf"
End Property
Public Property Get cur_lbf_err() As Boolean
    cur_lbf_err = Unit_cur_lbf.bError
End Property

'=================[ ozf ]
Public Property Get cur_ozf() As Double
    cur_ozf = Unit_cur_ozf.curVal
End Property
Public Property Let cur_ozf(ByVal New_cur_ozf As Double)
    Unit_cur_ozf.curVal = New_cur_ozf
    UpdateUnits "ozf", Unit_cur_ozf.curVal
    PropertyChanged "cur_ozf"
End Property
Public Property Get cur_ozf_err() As Boolean
    cur_ozf_err = Unit_cur_ozf.bError
End Property
...
Private Sub UserControl_Initialize()
    'set default values
    Unit_cur_N.defVal = 1#
    Unit_cur_gf.defVal = 101.97162129779#
    Unit_cur_kgf.defVal = 0.10197162129779#
    Unit_cur_lbf.defVal = 0.2248089431#
    Unit_cur_ozf.defVal = 3.5969430896#
...
Private Sub UserControl_InitProperties()
    ...
    Unit_cur_N.curVal = Unit_cur_N.defVal
    Unit_cur_gf.curVal = Unit_cur_gf.defVal
    Unit_cur_kgf.curVal = Unit_cur_kgf.defVal
    Unit_cur_lbf.curVal = Unit_cur_lbf.defVal
    Unit_cur_ozf.curVal = Unit_cur_ozf.defVal
    StartUp
End Sub
...
Private Sub UserControl_ReadProperties(PropBag As PropertyBag)
    ...
    Unit_cur_N.curVal = PropBag.ReadProperty("cur_N", Unit_cur_N.defVal)
    Unit_cur_gf.curVal = PropBag.ReadProperty("cur_gf", Unit_cur_gf.defVal)
    Unit_cur_kgf.curVal = PropBag.ReadProperty("cur_kgf", Unit_cur_kgf.defVal)
    Unit_cur_lbf.curVal = PropBag.ReadProperty("cur_lbf", Unit_cur_lbf.defVal)
    Unit_cur_ozf.curVal = PropBag.ReadProperty("cur_ozf", Unit_cur_ozf.defVal)
    StartUp
End Sub
...
Private Sub UserControl_WriteProperties(PropBag As PropertyBag)
    ...
    Call PropBag.WriteProperty("cur_N", Unit_cur_N.curVal, Unit_cur_N.defVal)
    Call PropBag.WriteProperty("cur_gf", Unit_cur_gf.curVal, Unit_cur_gf.defVal)
    Call PropBag.WriteProperty("cur_kgf", Unit_cur_kgf.curVal, Unit_cur_kgf.defVal)
    Call PropBag.WriteProperty("cur_lbf", Unit_cur_lbf.curVal, Unit_cur_lbf.defVal)
    Call PropBag.WriteProperty("cur_ozf", Unit_cur_ozf.curVal, Unit_cur_ozf.defVal)
End Sub
...
Private Sub LoadUnitColAndComboBox()
    ...
    Unit_cur_N.uName = "N": UnitCol.Add Unit_cur_N, "N"
    Unit_cur_gf.uName = "gf": UnitCol.Add Unit_cur_gf, "gf"
    Unit_cur_kgf.uName = "kgf": UnitCol.Add Unit_cur_kgf, "kgf"
    Unit_cur_lbf.uName = "lbf": UnitCol.Add Unit_cur_lbf, "lbf"
    Unit_cur_ozf.uName = "ozf": UnitCol.Add Unit_cur_ozf, "ozf"
    'load combobox
    Combo1.Clear
