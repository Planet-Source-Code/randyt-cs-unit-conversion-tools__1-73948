VERSION 5.00
Begin VB.UserControl LengthControl
   ClientHeight    =   915
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   2595
   ...
   End
End
Attribute VB_Name = "LengthControl"
...
Private Unit_cur_in As New UnitElementCls
Private Unit_cur_ft As New UnitElementCls
Private Unit_cur_yd As New UnitElementCls
Private Unit_cur_mm As New UnitElementCls
Private Unit_cur_cm As New UnitElementCls
Private Unit_cur_m As New UnitElementCls
...
Public Property Let ctl_sigDigits(ByVal New_ctl_sigDigits As Integer)
    ...
    UpdateUnits "in", Unit_cur_in.curVal
...
Public Property Get cur_in() As Double
    cur_in = Unit_cur_in.curVal
End Property
Public Property Let cur_in(ByVal New_cur_in As Double)
    Unit_cur_in.curVal = New_cur_in
    UpdateUnits "in", Unit_cur_in.curVal
    PropertyChanged "cur_in"
End Property
Public Property Get cur_in_err() As Boolean
    cur_in_err = Unit_cur_in.bError
End Property

'=================[ ft ]
Public Property Get cur_ft() As Double
    cur_ft = Unit_cur_ft.curVal
End Property
Public Property Let cur_ft(ByVal New_cur_ft As Double)
    Unit_cur_ft.curVal = New_cur_ft
    UpdateUnits "ft", Unit_cur_ft.curVal
    PropertyChanged "cur_ft"
End Property
Public Property Get cur_ft_err() As Boolean
    cur_ft_err = Unit_cur_ft.bError
End Property

'=================[ yd ]
Public Property Get cur_yd() As Double
    cur_yd = Unit_cur_yd.curVal
End Property
Public Property Let cur_yd(ByVal New_cur_yd As Double)
    Unit_cur_yd.curVal = New_cur_yd
    UpdateUnits "yd", Unit_cur_yd.curVal
    PropertyChanged "cur_yd"
End Property
Public Property Get cur_yd_err() As Boolean
    cur_yd_err = Unit_cur_yd.bError
End Property

'=================[ mm ]
Public Property Get cur_mm() As Double
    cur_mm = Unit_cur_mm.curVal
End Property
Public Property Let cur_mm(ByVal New_cur_mm As Double)
    Unit_cur_mm.curVal = New_cur_mm
    UpdateUnits "mm", Unit_cur_mm.curVal
    PropertyChanged "cur_mm"
End Property
Public Property Get cur_mm_err() As Boolean
    cur_mm_err = Unit_cur_mm.bError
End Property

'=================[ cm ]
Public Property Get cur_cm() As Double
    cur_cm = Unit_cur_cm.curVal
End Property
Public Property Let cur_cm(ByVal New_cur_cm As Double)
    Unit_cur_cm.curVal = New_cur_cm
    UpdateUnits "cm", Unit_cur_cm.curVal
    PropertyChanged "cur_cm"
End Property
Public Property Get cur_cm_err() As Boolean
    cur_cm_err = Unit_cur_cm.bError
End Property

'=================[ m ]
Public Property Get cur_m() As Double
    cur_m = Unit_cur_m.curVal
End Property
Public Property Let cur_m(ByVal New_cur_m As Double)
    Unit_cur_m.curVal = New_cur_m
    UpdateUnits "m", Unit_cur_m.curVal
    PropertyChanged "cur_m"
End Property
Public Property Get cur_m_err() As Boolean
    cur_m_err = Unit_cur_m.bError
End Property
...
Private Sub UserControl_Initialize()
    'set default values
    Unit_cur_in.defVal = 39.370078740158#
    Unit_cur_ft.defVal = 3.2808398950131#
    Unit_cur_yd.defVal = 1.0936132983377#
    Unit_cur_mm.defVal = 1000#
    Unit_cur_cm.defVal = 100#
    Unit_cur_m.defVal = 1#
...
Private Sub UserControl_InitProperties()
    ...
    Unit_cur_in.curVal = Unit_cur_in.defVal
    Unit_cur_ft.curVal = Unit_cur_ft.defVal
    Unit_cur_yd.curVal = Unit_cur_yd.defVal
    Unit_cur_mm.curVal = Unit_cur_mm.defVal
    Unit_cur_cm.curVal = Unit_cur_cm.defVal
    Unit_cur_m.curVal = Unit_cur_m.defVal
    StartUp
End Sub
...
Private Sub UserControl_ReadProperties(PropBag As PropertyBag)
    ...
    Unit_cur_in.curVal = PropBag.ReadProperty("cur_in", Unit_cur_in.defVal)
    Unit_cur_ft.curVal = PropBag.ReadProperty("cur_ft", Unit_cur_ft.defVal)
    Unit_cur_yd.curVal = PropBag.ReadProperty("cur_yd", Unit_cur_yd.defVal)
    Unit_cur_mm.curVal = PropBag.ReadProperty("cur_mm", Unit_cur_mm.defVal)
    Unit_cur_cm.curVal = PropBag.ReadProperty("cur_cm", Unit_cur_cm.defVal)
    Unit_cur_m.curVal = PropBag.ReadProperty("cur_m", Unit_cur_m.defVal)
    StartUp
End Sub
...
Private Sub UserControl_WriteProperties(PropBag As PropertyBag)
    ...
    Call PropBag.WriteProperty("cur_in", Unit_cur_in.curVal, Unit_cur_in.defVal)
    Call PropBag.WriteProperty("cur_ft", Unit_cur_ft.curVal, Unit_cur_ft.defVal)
    Call PropBag.WriteProperty("cur_yd", Unit_cur_yd.curVal, Unit_cur_yd.defVal)
    Call PropBag.WriteProperty("cur_mm", Unit_cur_mm.curVal, Unit_cur_mm.defVal)
    Call PropBag.WriteProperty("cur_cm", Unit_cur_cm.curVal, Unit_cur_cm.defVal)
    Call PropBag.WriteProperty("cur_m", Unit_cur_m.curVal, Unit_cur_m.defVal)
End Sub
...
Private Sub LoadUnitColAndComboBox()
    ...
    Unit_cur_in.uName = "in": UnitCol.Add Unit_cur_in, "in"
    Unit_cur_ft.uName = "ft": UnitCol.Add Unit_cur_ft, "ft"
    Unit_cur_yd.uName = "yd": UnitCol.Add Unit_cur_yd, "yd"
    Unit_cur_mm.uName = "mm": UnitCol.Add Unit_cur_mm, "mm"
    Unit_cur_cm.uName = "cm": UnitCol.Add Unit_cur_cm, "cm"
    Unit_cur_m.uName = "m": UnitCol.Add Unit_cur_m, "m"
    'load combobox
    Combo1.Clear
