VERSION 5.00
Begin VB.UserControl StressControl
   ClientHeight    =   915
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   2595
   ...
   End
End
Attribute VB_Name = "StressControl"
...
Private Unit_cur_psi As New UnitElementCls
Private Unit_cur_kpa As New UnitElementCls
...
Public Property Let ctl_sigDigits(ByVal New_ctl_sigDigits As Integer)
    ...
    UpdateUnits "psi", Unit_cur_psi.curVal
...
'=================[ psi ]
Public Property Get cur_psi() As Double
    cur_psi = Unit_cur_psi.curVal
End Property
Public Property Let cur_psi(ByVal New_cur_psi As Double)
    Unit_cur_psi.curVal = New_cur_psi
    UpdateUnits "psi", Unit_cur_psi.curVal
    PropertyChanged "cur_psi"
End Property
Public Property Get cur_psi_err() As Boolean
    cur_psi_err = Unit_cur_psi.bError
End Property

'=================[ kpa ]
Public Property Get cur_kpa() As Double
    cur_kpa = Unit_cur_kpa.curVal
End Property
Public Property Let cur_kpa(ByVal New_cur_kpa As Double)
    Unit_cur_kpa.curVal = New_cur_kpa
    UpdateUnits "kpa", Unit_cur_kpa.curVal
    PropertyChanged "cur_kpa"
End Property
Public Property Get cur_kpa_err() As Boolean
    cur_kpa_err = Unit_cur_kpa.bError
End Property
...
Private Sub UserControl_Initialize()
    'set default values
    Unit_cur_psi.defVal = 14.695948775492#
    Unit_cur_kpa.defVal = 101.325#
...
Private Sub UserControl_InitProperties()
    ...
    Unit_cur_psi.curVal = Unit_cur_psi.defVal
    Unit_cur_kpa.curVal = Unit_cur_kpa.defVal
    StartUp
End Sub
...
Private Sub UserControl_ReadProperties(PropBag As PropertyBag)
    ...
    Unit_cur_psi.curVal = PropBag.ReadProperty("cur_psi", Unit_cur_psi.defVal)
    Unit_cur_kpa.curVal = PropBag.ReadProperty("cur_kpa", Unit_cur_kpa.defVal)
    StartUp
End Sub
...
Private Sub UserControl_WriteProperties(PropBag As PropertyBag)
    ...
    Call PropBag.WriteProperty("cur_psi", Unit_cur_psi.curVal, Unit_cur_psi.defVal)
    Call PropBag.WriteProperty("cur_kpa", Unit_cur_kpa.curVal, Unit_cur_kpa.defVal)
End Sub
...
Private Sub LoadUnitColAndComboBox()
    ...
    Unit_cur_psi.uName = "psi": UnitCol.Add Unit_cur_psi, "psi"
    Unit_cur_kpa.uName = "kpa": UnitCol.Add Unit_cur_kpa, "kpa"
    'load combobox
    Combo1.Clear
